# Fix Package: 0c747ad3af58ed6b27221a256498068e

This folder contains a set of pre-generated operations to merge duplicate
entities in the **0c747ad3af58ed6b27221a256498068e** space (`0c747ad3af58ed6b27221a256498068e`).
...
| `ops.json` | The raw operations to publish (38 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the 0c747ad3af58ed6b27221a256498068e space
