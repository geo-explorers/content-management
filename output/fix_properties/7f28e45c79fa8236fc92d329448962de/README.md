# Fix Package: 7f28e45c79fa8236fc92d329448962de

This folder contains a set of pre-generated operations to merge duplicate
entities in the **7f28e45c79fa8236fc92d329448962de** space (`7f28e45c79fa8236fc92d329448962de`).
...
| `ops.json` | The raw operations to publish (194 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the 7f28e45c79fa8236fc92d329448962de space
