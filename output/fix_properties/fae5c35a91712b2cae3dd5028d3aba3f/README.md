# Fix Package: fae5c35a91712b2cae3dd5028d3aba3f

This folder contains a set of pre-generated operations to merge duplicate
entities in the **fae5c35a91712b2cae3dd5028d3aba3f** space (`fae5c35a91712b2cae3dd5028d3aba3f`).
...
| `ops.json` | The raw operations to publish (44 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the fae5c35a91712b2cae3dd5028d3aba3f space
