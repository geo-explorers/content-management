# Fix Package: 7aed0e58f713f656e2933f7635f08e62

This folder contains a set of pre-generated operations to merge duplicate
entities in the **7aed0e58f713f656e2933f7635f08e62** space (`7aed0e58f713f656e2933f7635f08e62`).
...
| `ops.json` | The raw operations to publish (500 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the 7aed0e58f713f656e2933f7635f08e62 space
