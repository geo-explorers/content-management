# Fix Package: a070b8c196f28118335186ec4b4abce7

This folder contains a set of pre-generated operations to merge duplicate
entities in the **a070b8c196f28118335186ec4b4abce7** space (`a070b8c196f28118335186ec4b4abce7`).
...
| `ops.json` | The raw operations to publish (132 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the a070b8c196f28118335186ec4b4abce7 space
