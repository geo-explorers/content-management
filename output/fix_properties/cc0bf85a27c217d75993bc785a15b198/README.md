# Fix Package: cc0bf85a27c217d75993bc785a15b198

This folder contains a set of pre-generated operations to merge duplicate
entities in the **cc0bf85a27c217d75993bc785a15b198** space (`cc0bf85a27c217d75993bc785a15b198`).
...
| `ops.json` | The raw operations to publish (2 ops) |
| `publish.ts` | A self-contained script that publishes the ops on-chain |

## Prerequisites

- [Bun](https://bun.sh) installed
- You must be an **editor** of the cc0bf85a27c217d75993bc785a15b198 space
